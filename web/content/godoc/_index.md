...
<div class="landing-grid">
  <a class="landing-card" href="storage/">
    <i class="fas fa-database landing-card-icon" style="color: #93c5fd;"></i>
    <div>
      <strong>storage</strong>
      <p>Multi-backend S3 object management with quota enforcement, replication, and rebalancing.</p>
    </div>
  </a>
  <a class="landing-card" href="server/">
    ...
    <div>
      ...
      <p>S3-compatible HTTP server with SigV4 authentication and request routing.</p>
    </div>
  </a>
  <a class="landing-card" href="config/">
    ...
    <div>
      ...
      <p>YAML configuration loading and validation.</p>
    </div>
  </a>
  ...
  <a class="landing-card" href="auth/">
    ...
    <div>
      <strong>auth</strong>
      <p>SigV4 request signing and credential validation.</p>
    </div>
  </a>
  ...
  <a class="landing-card" href="lifecycle/">
    ...
    <div>
      ...
      <p>Automatic object expiration with configurable prefix rules.</p>
    </div>
  </a>
  ...
  <a class="landing-card" href="telemetry/">
    ...
    <div>
      ...
      <p>Prometheus metrics and OpenTelemetry tracing.</p>
    </div>
  </a>
