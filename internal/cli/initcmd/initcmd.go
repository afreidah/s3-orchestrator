...
// Package initcmd implements the `s3-orchestrator init` subcommand,
// which interactively walks an operator through writing a baseline
// config.yaml suitable for first boot.
package initcmd
