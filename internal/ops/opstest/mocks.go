...
// Source: github.com/afreidah/s3-orchestrator/internal/ops (interfaces: ObjectAPI,ObjectStore,UsageGate,IntegrityConfigLoader,RuntimeOps,ReplicatorOps,RebalancerOps,OverReplicationOps,ScrubberOps,AdvisoryLocker,EncryptionStore,CompressionStore,ProvisioningStore,NamespaceCounter,RegistryPublisher)
//
...
func (m *MockAdvisoryLocker) WithAdvisoryLock(ctx context.Context, lockID int64, fn func(context.Context) error) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAdvisoryLockerMockRecorder) WithAdvisoryLock(ctx, lockID, fn any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithAdvisoryLock", reflect.TypeOf((*MockAdvisoryLocker)(nil).WithAdvisoryLock), ctx, lockID, fn)
}
